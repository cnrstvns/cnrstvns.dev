...
export default function Index() {
  return (
    <>
      <div className="flex flex-col p-10 lg:flex-row min-h-screen overflow:hidden md:overflow-auto items-start md:items-center justify-center space-y-10 lg:space-y-0 lg:space-x-10">
        <Image
