            ...
            <div className="space-y-3">
              <div>
                ...
                <div className="text-base mt-2">
                  ...
                  support, overseeing marketing operations, and managing most
                  engineering tasks. During my time at Hyper, our customer count
                  more than tripled and our monthly GMV (gross payments volume
                  processed) grew by over 5x.
                </div>
              </div>
              <div>
                <div className="font-semibold text-xl text-blue-300">
                ...
                <div className="text-base mt-2">
                  Responsible for consulting with Discord-based communities in
                  the sneaker aftermarket space for their custom software needs.
          ...
          <div>
            ...
            <div className="space-y-3">
              <div>
                ...
                <div className="text-base">
                  <span className="font-semibold">Honors:</span> Dean&apos;s
                  List
                </div>
                <div className="text-base">
