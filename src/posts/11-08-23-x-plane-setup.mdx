...
I was going to write about this; I have tiles installed at ZL18 for all of NY,
NJ, parts of VT, CT, PA, and more, but the app for it will not launch properly
anymore. It took extremely long for it to create the tiles in the first place,
and I think I'll replace this scenery with static orthophotos on my SSD using
Ortho4XP. Now I know why the forums recommended one over the other so heavily.
