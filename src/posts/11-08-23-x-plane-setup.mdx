...
have this system available to them. Due to some compatibility issues in X-Plane
12, I had to install a modified version of this plugin. You can download it for
free from [GitHub](https://github.com/olivierbutler/X-RAAS2-xp12). Thanks to
"Olivier" for putting in the work on this.
...
properly (maybe even purchase XOrganizer). You should definitely check out
AutoOrtho. You can get a lot of the benefits of Ortho4XP without sacrificing the
disk space. Find out more about it
...
xPilot is a VATSIM client for X-Plane. As I get back in to simming and begin to
take it more seriously, I intend to start flying on VATSIM. This application
allows me to do so. Check it out [here](https://docs.xpilot-project.org/).
