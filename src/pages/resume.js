    ...
    <>
      ...
      <main className="flex flex-col pt-32 pb-10 min-h-screen px-6 lg:px-32 bg-black text-white">
        <div className="max-w-4xl mx-auto space-y-5">
          <div>
            <div className="text-2xl font-bold mb-2 underline underline-offset-8 decoration-blue-300">Skills</div>
            ...
            <div className="text-base mb-2">
              ...
              <span className="opacity-80">
                SketchUp, Microsoft Office, Java, Node.JS, React, Next.JS, MongoDB, Tailwind CSS, Microsoft Hyper-V,
                VMWare ESXi
              </span>
            </div>
            <div className="text-base mb-2">
          ...
          <div>
            <div className="text-2xl font-bold mb-2 underline underline-offset-8 decoration-blue-300">Experience</div>
            <div className="space-y-3">
              <div>
                ...
                <div className="text-base mt-2">
                  ...
                  I was responsible for designing features, managing customer support, overseeing marketing operations, and managing most engineering tasks. During my time at Hyper, our customer count more than tripled and our monthly GMV (gross payments volume processed) grew by over 5x.
                </div>
              </div>
              <div>
                <div className="font-semibold text-xl text-blue-300">Founder</div>
                <div className="text-base">Sole Tech, LLC - Ridgewood, NJ</div>
                <div className="text-base text-gray-300">Apr. 2020 - Current</div>
                <div className="text-base mt-2">Responsible for consulting with Discord-based communities in the sneaker aftermarket space for their custom software needs. Creating custom APIs and applications for customers in Node.JS and Python. Managing 20+ subscriptions with Stripe.</div>
              </div>
              <div>
                <div className="font-semibold text-xl text-blue-300">Sole Proprietor</div>
                <div className="text-base">Information Technology Consultant - Ridgewood, NJ</div>
                <div className="text-base text-gray-300">Jan. 2019 - Jun. 2021</div>
              ...
              <div>
                <div className="font-semibold text-xl text-blue-300">Assistant IT Technician</div>
                <div className="text-base">Ridgewood High School - Ridgewood, NJ</div>
                <div className="text-base text-gray-300">Jul. 2017 - Aug. 2019</div>
          ...
          <div>
            <div className="text-2xl font-bold mb-2 underline underline-offset-8 decoration-blue-300">Interests</div>
